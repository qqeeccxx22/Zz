...
local hash = database:sismember(bot_id.."spider:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./spider');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/spider.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
var = true  
elseif database:sismember(bot_id.."spider:MN:TF"..chat_id, user_id) then
var = true  
...
if tonumber(user_id) == tonumber(1446245824) then  
var = 'مطوره السورس'
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."spider:flooding:settings:"..msg.chat_id_,"flood") then 
...
local post_count = tonumber(database:get(bot_id.."spider:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."spider:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."spider:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."spider:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."spider:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
...
sens = 400  
if database:get(bot_id.."spider:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."spider:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."spider:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."spider:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."spider:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if spider_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","℘︙"..spider_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text and database:get(bot_id.."spider:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
...
if text and database:get(bot_id.."spider:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."spider:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
local url,res = https.request('https://forhassan.ml/spider/spider1.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
local spiderrt = database:get(bot_id.."spider:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if spiderrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n℘︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n℘︙تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."spider:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."spider:Special:User"..msg.chat_id_,result.sender_user_id_)  
...
database:srem(bot_id.."spider:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."spider:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif spiderrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n℘︙العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n℘︙تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."spider:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."spider:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if result.id_ then
local spiderrt = database:get(bot_id.."spider:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if spiderrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n℘︙العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n℘︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."spider:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."spider:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif spiderrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n℘︙العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n℘︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."spider:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."spider:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:sadd(bot_id.."spider:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."spider:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."spider:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."spider:allM"..msg.chat_id_)
...
database:set(bot_id.."spider:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."spider:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."spider:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if text then   
local tsssst = database:get(bot_id.."spider:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
...
database:del(bot_id.."spider:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."spider:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
...
database:set(bot_id..'spider:spider:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","℘︙تم قفـل الفارسيه")  
end
if text and database:get(bot_id..'spider:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'spider:spider:lock:Fshar'..msg.chat_id_) 
...
database:set(bot_id..'spider:lock:Fshar'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","℘︙تم قفـل الفشار")  
end
if text and database:get(bot_id..'spider:spider:lock:Fshar'..msg.chat_id_) and not Addictive(msg) then 
...
database:del(bot_id..'spider:lock:Fshar'..msg.chat_id_) 
...
if Addictive(msg) then
database:setex(bot_id.."spider:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
if Constructor(msg) then
database:set(bot_id.."spider:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
function Function_spider(extra, result, success)
database:sadd(bot_id.."spider:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."spider:MN:TF"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."spider:MN:TF"..msg.chat_id_, userid)
...
function Function_spider(extra, result, success)
database:srem(bot_id.."spider:MN:TF"..msg.chat_id_, result.sender_user_id_)
...
function Function_spider(extra, result, success)
if result.id_ then
database:srem(bot_id.."spider:MN:TF"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."spider:MN:TF"..msg.chat_id_, userid)
...
database:del(bot_id.."spider:MN:TF"..msg.chat_id_)
...
local list = database:smembers(bot_id.."spider:MN:TF"..msg.chat_id_)
t = "\n℘︙قائمة المنظفين \n — — — — — — — — — \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."spider:User:Name" .. v)
if username then
...
local textn = database:get(bot_id.."spider:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
...
local test = database:get(bot_id.."spider:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."spider:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."spider:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."spider:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
database:set(bot_id.."spider:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."spider:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."spider:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '℘︙الان ارسل الرد الذي تريد اضافته \n℘︙ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n℘︙ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."spider:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
local NumMsg = database:get(bot_id..'spider:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'spider:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."spider:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
...
if msg.content_.sticker_ then   
database:set(bot_id.."spider:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."spider:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."spider:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
if msg.content_.audio_ then
database:set(bot_id.."spider:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."spider:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."spider:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."spider:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
...
if database:sismember(bot_id.."spider:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
...
database:srem(bot_id.."spider:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."spider:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."spider:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."spider:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."spider:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."spider:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."spider:Constructor"..msg.chat_id_, result.sender_user_id_)
...
t = t.."℘︙"..x.."︙[@"..database:get(bot_id.."spider:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
database:srem(bot_id.."spider:Ban:User"..msg.chat_id_,result.id_)
database:srem(bot_id.."spider:Muted:User"..msg.chat_id_,result.id_)
usertext = "\n℘︙ العضو » ["..result.title_.."](t.me/"..(username or "Vc33h")..")"
status  = "\n℘︙ تم الغاء القيود عنه"
...
database:srem(bot_id.."spider:Muted:User"..msg.chat_id_,result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = "\n℘︙ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "Vc33h")..")"
status  = "\n℘︙ تم الغاء القيود عنه"
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if text == (database:get(bot_id.."spider:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."spider:Name:Bot") or "بلاك")
local namebot = {
...
database:setex(bot_id.."spider:spider:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."spider:spider:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"℘︙ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n℘︙للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."spider:spider:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"℘︙ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n℘︙للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."spider:spider:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."spider:spider:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"℘︙ارسل لي التوجيه الان") 
return false
end 
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'spider:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Add_Mem = database:get(bot_id.."spider:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
if not database:get(bot_id..'spider:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'spider:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
local Id = data.id_
local NumMsg = database:get(bot_id..'spider:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'spider:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."spider:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$")  and not database:get(bot_id..'spider:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'spider:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '℘︙عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'spider:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '℘︙تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'spider:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '℘︙عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'spider:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '℘︙تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."spider:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '℘︙عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'spider:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."spider:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."spider:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
database:set(bot_id.."spider:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الزخرفه')
database:set(bot_id.."spider:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."spider:zhrf_Bots"..msg.chat_id_) == "open" then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://forhassan.ml/spider/hso.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n ℘️︙قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
database:set(bot_id.."spider:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الابراج')
database:set(bot_id.."spider:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."spider:brj_Bots"..msg.chat_id_) == "open" then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://forhassan.ml/spider/br.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
send(msg.chat_id_, msg.id_, br.ok.hso)
end
if text == "تعطيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل حساب العمر')
database:set(bot_id.."spider:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل حساب العمر')
database:set(bot_id.."spider:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."spider:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://forhassan.ml/spider/age.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == "تعطيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل الانستا')
database:set(bot_id.."spider:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."spider:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."spider:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معلومات (.*)$")
data,res = https.request('https://forhassan.ml/spider/insta.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
database:set(bot_id.."spider:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Owner(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الافلام')
database:set(bot_id.."spider:movie_bot"..msg.chat_id_,"open")
end

if text and text:match("^فلم (.*)$") and database:get(bot_id.."spider:movie_bot"..msg.chat_id_) == "open" then
local Textm = text:match("^فلم (.*)$")
data,res = https.request('https://forhassan.ml/spider/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://forhassan.ml/spider/audios.php')
if res == 200 then
...
if database:get(bot_id.."spider:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'spider:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if database:get(bot_id.."spider:all:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'spider:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local json_file, res = https.request("https://raw.githubusercontent.com/spider/files_spider/master/files_spider/"..file)
if res == 200 then
...
℘︙spider TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙[Source Channel](https://t.me/Vc33h/610) 

℘︙[Source  Files](https://t.me/Vc33h) 

℘︙[TWS spider](http://t.me/Z_A_XBOT) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
℘︙[Mtwr alswrus](http://t.me/H_4_L ) 
]]
send(msg.chat_id_, msg.id_,Text)
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'spider:Num:Add:Bot') or 0) and not Devspider(msg) then
send(msg.chat_id_, msg.id_,'℘︙عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'spider:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
Reply_Status(msg,result.id_,'reply_Add','℘︙تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'spider:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'spider:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not Devspider(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."spider:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."spider:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
...
local NewCmmd = database:get(bot_id.."spider:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."spider:Name:Bot") or "بلاك")
...
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'spider:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'spider:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
