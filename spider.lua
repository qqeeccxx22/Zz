...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,833156404,1446245824}
print("\27[34m"..[[
...
if hash or Devspider(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Devspider(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "spiderTEAM")
...
database:set(bot_id.."spider:Lock:Xn"..msg.chat_id_,"del")  
...
database:del(bot_id.."spider:Lock:Xn"..msg.chat_id_)  
...
if text == (database:get(bot_id.."spider:Name:Bot") or "سبايدر") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."spider:Name:Bot") or "سبايدر")
local namebot = {
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and database:get(bot_id.."spider:Lock:Xn"..msg.chat_id_)=="del" then      
...
if #list == 0 then
t = "⌔∮ماكو منشئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","⌔∮قام بنشر ملصق اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and database:get(bot_id.."spider:Lock:Xn"..msg.chat_id_)=="del" then
...
local Name_Bot = (database:get(bot_id.."spider:Name:Bot") or "سبايدر")
