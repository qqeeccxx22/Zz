...
local NumMsgg = database:get(bot_id..'Num:message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local NumMsg =( database:get(bot_id..'Num:message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0 + NumMsgg)
