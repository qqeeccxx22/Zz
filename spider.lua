...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,833156404,1033028167}
...
if hash or Bot(msg) or Devspider(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or Devspider(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or Devspider(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if text == ("قائمه كتم عام") and Devspider(msg) then
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Devspider(msg) then
function Function_spider(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and Devspider(msg) then
...
if text and text:match("^كتم عام (%d+)$") and Devspider(msg) then
...
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "Vc33h")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
...
if spiderrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..result.title_.."](t.me/"..(text1[3] or "Vc33h")..")".."\n✫: تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
zh = https.request('https://spider-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n✫️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://spider-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://spider-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
data,res = https.request('https://spider-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://spider-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://spider-api.ml/audios.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/Vc33h"}},
}
local msg_id = msg.id_/2097152/0.5
...
st = https.request('https://spider-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://spider-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local url,res = https.request('https://spider-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @Vc33h .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ\n\n[-  ʙᴏʏᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://t.me/Vc33h)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/pvv_v)\n\n[-  ʙᴏʏᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/KKKKK4)\n\n[-  ʙᴏᴛ ʙᴏʏᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/Vc33h"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vc33h&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == ("قائمه المكتومين العام ✫") and Devspider(msg) then
local list = database:smembers(bot_id.."Gmute:User")
...
inline = {
{{text = '✫:  - 𝘴𝘰𝘳𝘶𝘤𝘦 𝘴𝘱𝘪𝘥𝘦𝘳  .',url='http://t.me/Vc33h'}},
}
