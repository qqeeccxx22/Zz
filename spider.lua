...
if hash or Devspider(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or Bot(msg) then        
return true 
else 
return false 
end 
...
if database:get(bot_id.."Tshak:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Tshak:Set:Maany"..msg.chat_id_)
Maany_Rand = {'9','46','2','9','5','4','25','10','17','15','39','5','16',};
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."Tshak:Maany"..msg.chat_id_,name)
...
send(msg.chat_id_, msg.id_,"⌔∮اكمل المعادله التاليه ~ {"..name.."}")
return false
end
end
if text == ""..(database:get(bot_id.."Tshak:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."Tshak:Set:Maany"..msg.chat_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Spider source .',url="t.me/Vc33h"}},
}
local msg_id = msg.id_/2097152/0.5
