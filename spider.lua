...
local UserName = (data.username_ or "spider_SoUrcE")
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and spiderDevSou(msg) then
function Function_spider(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and spiderDevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and spiderDevSou(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devspider(msg) then
function Function_spider(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and Devspider(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and Devspider(msg) then
...
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
𝘊𝘩 - [𝘯𝘪𝘨𝘨𝘢](http://t.me/spider_SoUrcE)•
]]
send(msg.chat_id_, msg.id_,Text)
...
if text == ("تاك جميع الرتب") and Addictive(msg) then   
...
if text == ("تاك") and Addictive(msg) then   
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200
},function(ta,spider)
local t = "\n*⋄︙قائمة الاعضاء \n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n*"
x = 0
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'spider_SoUrcE')..')'
...
local UserName = (b.username_ or "spider_SoUrcE")
...
if text == 'نقودي' or text == 'نقاطي' then
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━⋄︙
- Ch [ᥰᎥᧁᧁꪖ - SoUrCe](https://t.me/spider_SoUrcE)
]]
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Black TeAM .',url="t.me/spider_SoUrcE"}},
}
local msg_id = msg.id_/2097152/0.5
...
if Devspider(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_spider/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_spider/main/files_spider/"..file)
if res == 200 then
...
Text = [[
╭⋄︙[𝑵𝒊𝑮𝑮𝑨 𝑺𝑶𝑼𝑹𝑺𝑬](t.me/spider_SoUrcE) •╮
]]
send(msg.chat_id_, msg.id_,Text)
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس سبايدر' or text == 'اريد بوت تمبلر' or text == 'سورس سبايدر' then
Text = [[
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس سبايدر
...
if text == '@IIIIIX' or text == '@spider_SoUrcE' or text == 'مودي البدراني' then
Text = [[
@IIIIIX هذا مطور سورس سبايدر
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
inline = {
{{text = '⋄︙ ᥰᎥᧁᧁꪖ  .',url='http://t.me/spider_SoUrcE'}},
}
