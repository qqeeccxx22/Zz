...
Create_Info(redis:get(Server_Done.."Token_spider"),redis:get(Server_Done.."UserSudo_Write"))   
...
Files_Info_Get()
redis:del(Server_Done.."Token_spider");redis:del(Server_Done.."UserSudo_Write")
