...
if hash or DevLARViN(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./LARViN');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/LARViN.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
if DevLARViNe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."LARViN:Sudo:User", user_id) then
...
local UserName = (data.username_ or "Source_Milano")
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."LARViN:flooding:settings:"..msg.chat_id_,"flood") then 
...
local post_count = tonumber(database:get(bot_id.."LARViN:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."LARViN:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."LARViN:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."LARViN:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."LARViN:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
...
sens = 400  
if database:get(bot_id.."LARViN:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."LARViN:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."LARViN:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."LARViN:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."LARViN:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if LARViN_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..LARViN_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text and database:get(bot_id.."LARViN:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
...
if text and database:get(bot_id.."LARViN:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."LARViN:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevLARViN(msg) then
function Function_LARViN(extra, result, success)
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevLARViN(msg) then
function Function_LARViN(extra, result, success)
...
local url,res = http.request('http://LARViN.ml/joinch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.LARViN == 0 then
...
local LARViNrt = database:get(bot_id.."LARViN:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if LARViNrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."LARViN:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."LARViN:Special:User"..msg.chat_id_,result.sender_user_id_)  
...
database:srem(bot_id.."LARViN:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."LARViN:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif LARViNrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم تنزيله من "..RTPA.." هنا\n")   
database:srem(bot_id.."LARViN:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."LARViN:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if result.id_ then
local LARViNrt = database:get(bot_id.."LARViN:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if LARViNrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."LARViN:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."LARViN:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif LARViNrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n📬┇تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."LARViN:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."LARViN:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_LARViN, nil)
return false
end
------------------------------------------------------------------------
...
database:setex(bot_id.."LARViN:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
...
database:set(bot_id.."LARViN:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."LARViN:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."LARViN:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if text then   
local tsssst = database:get(bot_id.."LARViN:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
...
database:del(bot_id.."LARViN:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LARViN:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
...
if Addictive(msg) then
database:setex(bot_id.."LARViN:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
if Constructor(msg) then
database:set(bot_id.."LARViN:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local textn = database:get(bot_id.."LARViN:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
...
local test = database:get(bot_id.."LARViN:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."LARViN:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."LARViN:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."LARViN:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
database:set(bot_id.."LARViN:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."LARViN:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."LARViN:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '📥┇الان ارسل الرد الذي تريد اضافته \n📥┇ قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."LARViN:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
local NumMsg = database:get(bot_id..'LARViN:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'LARViN:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text == ("ردود المطور") and DevLARViN(msg) then 
local list = database:smembers(bot_id.."LARViN:List:Rd:Sudo")
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."LARViN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
...
if msg.content_.sticker_ then   
database:set(bot_id.."LARViN:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."LARViN:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."LARViN:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
if msg.content_.audio_ then
database:set(bot_id.."LARViN:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."LARViN:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."LARViN:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if text == "حذف رد للكل" and DevLARViN(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
...
database:set(bot_id.."LARViN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
...
if database:sismember(bot_id.."LARViN:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
...
database:srem(bot_id.."LARViN:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARViN:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."LARViN:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."LARViN:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARViN:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARViN:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."LARViN:Constructor"..msg.chat_id_, result.sender_user_id_)
...
t = t..""..x.." - {[@"..database:get(bot_id.."LARViN:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
local UserName = (b.username_ or "Source_Milano")
...
if text == (database:get(bot_id.."LARViN:Name:Bot") or "تشاكي") then
Namebot = (database:get(bot_id.."LARViN:Name:Bot") or "تشاكي")
local namebot = {
...
database:setex(bot_id.."LARViN:LARViN:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."LARViN:LARViN:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."LARViN:LARViN:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:setex(bot_id.."LARViN:LARViN:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."LARViN:LARViN:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥┇ارسل لي التوجيه الان") 
return false
end 
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'LARViN:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'LARViN:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."LARViN:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."LARViN:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local Id = data.id_
local NumMsg = database:get(bot_id..'LARViN:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'LARViN:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."LARViN:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'LARViN:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'LARViN:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '📨┇عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'LARViN:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'LARViN:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '✏┇عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'LARViN:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."LARViN:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '👥┇عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'LARViN:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."LARViN:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."LARViN:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
download_to_file('https://raw.githubusercontent.com/LARViNTeam/LARViN/master/LARViN.lua', 'LARViN.lua') 
download_to_file('https://raw.githubusercontent.com/LARViNTeam/LARViN/master/start.lua', 'start.lua') 
dofile('LARViN.lua')  
return false
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/LARViNTeam/files_LARViN/master/files_LARViN/"..file)
if res == 200 then
...
local list1 = database:smembers('LARViN:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."LARViN:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('LARViN:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."LARViN:Constructor"..Groups[i], v)
end
local list3 = database:smembers('LARViN:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."LARViN:Manager"..Groups[i], v)
end
local list4 = database:smembers('LARViN:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."LARViN:Mod:User"..Groups[i], v)
end
database:set(bot_id.."LARViN:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'LARViN:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
database:set(bot_id..'LARViN:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'LARViN:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'LARViN:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
🌐┇LARViN TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/Source_Milano)

📋┇ [LARViN Dev](https://t.me/Source_Milano)

📁┇ [Source  Files](https://t.me/LARViN_sudo)

🌐┇ [LARViN iNDT](https://t.me/Source_Milano/4611)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS LARViN](https://t.me/A_5bot)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'LARViN:Num:Add:Bot') or 0) and not DevLARViN(msg) then
send(msg.chat_id_, msg.id_,'👥┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'LARViN:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
database:set(bot_id.."LARViN:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
Reply_Status(msg,result.id_,'reply_Add','☑┇تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'LARViN:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'LARViN:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not DevLARViN(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."LARViN:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."LARViN:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
...
local NewCmmd = database:get(bot_id.."LARViN:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."LARViN:Name:Bot") or "تشاكي")
...
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'LARViN:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'LARViN:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
