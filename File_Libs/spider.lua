...
--]]
database = dofile("./File_Libs/redis.lua").connect("127.0.0.spider)
...
send(msg.chat_id_, msg.id_,"\n܂𓍼 ⁝ تم تنزيله من الرتب الاتيه \n܂𓍼 ⁝  { " .. dev .. "" .. crr .. "" .. cr .. "" .. own .. "" .. mod .. "" .. vip .. " } \n")
else
                ...
                if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    ...
                    function Function_spider(extra, result, success)
                        tdcli_function({
                            ...
                            if data.first_name_ == false then
 send(msg.chat_id_, msg.id_, '܂𓍼 ⁝  الحساب محذوف لا توجد معلوماته ')
                                return false
                            end
    if data.username_ then
    UserName_User = '@' .. data.username_
...
܂𓍼 ⁝ بيع مجوهراتي + العدد » لستبدال كل مجوهره ب50 رساله
                ...
                if text == ("تحديث السورس") and Devspider(msg) then
                    ...
                    os.execute('wget https://raw.githubusercontent.com/spiders/spider/master/spider.lua')
                    os.execute('wget https://raw.githubusercontent.com/spiders/spider/master/start.lua')
                    dofile('spider.lua')
                    return false
                end
...
𓍼 ⁝ spider TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓍼 ⁝ [Source Channel](https://t.me/Vc33h) 
...
𓍼 ⁝ [TWS spider](http://t.me/H_4_L) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
                ...
                if text == 'الاوامر' and Addictive(msg) then
                    ...
                    Text = [[
܂𓍼 ⁝  هناك {5} اوامر لعرضها
 — — — — — — — — —
܂𓍼 ⁝  م1 » لعرض اوامر الحمايه
܂𓍼 ⁝  م2 » لعرض اوامر الادمنيه
܂𓍼 ⁝  م3 » لعرض اوامر المدراء
܂𓍼 ⁝  م4 » لعرض اوامر المنشئين
܂𓍼 ⁝  م5 » لعرض اوامر المطورين
 — — — — — — — — — 
  ܂𓍼 ⁝ [قناة السورس](t.me/Vc33h) 🔺.
]]
                ...
                if text == 'م1' and Addictive(msg) then
                    ...
                    Text = [[
܂𓍼 ⁝ اوامر حمايه المجموعه
 — — — — — — — — — 
܂𓍼 ⁝ قفل/فتح + الاوامر الادناه 
܂𓍼 ⁝ قفل/فتح + الامر بالتقيد • بالطرد • بالكتم
 — — — — — — — — — 
܂𓍼 ⁝ الروابط
܂𓍼 ⁝ المعرف
܂𓍼 ⁝ التاك
...
܂𓍼 ⁝ تنظيف + عدد
 — — — — — — — — — 
܂𓍼 ⁝ تفعيل/تعطيل الرفع
܂𓍼 ⁝ تفعيل/تعطيل الايدي
܂𓍼 ⁝ تفعيل/تعطيل اطردني
܂𓍼 ⁝ تفعيل/تعطيل ردود المدير
܂𓍼 ⁝ تفعيل/تعطيل ردود المطور
܂𓍼 ⁝ تفعيل/تعطيل الحظر/الطرد
܂𓍼 ⁝ تفعيل/تعطيل اللعبه/الالعاب
܂𓍼 ⁝ تفعيل/تعطيل الايدي بالصوره
܂𓍼 ⁝ تفعيل/تعطيل اوامر التحشيش
܂𓍼 ⁝ تفعيل/تعطيل الرابط/جلب الرابط
 — — — — — — — — — 
  ܂𓍼 ⁝  [قناة السورس](t.me/Vc33h) 
]]
                    send(msg.chat_id_, msg.id_, help_text or Text)
...
܂𓍼 ⁝ اضف/حذف امر
܂𓍼 ⁝ الاوامر المضافه
܂𓍼 ⁝ حذف/مسح الاوامر المضافه
܂𓍼 ⁝ اضف رسائل + العدد بالرد
܂𓍼 ⁝ اضف مجوهرات + العدد بالرد
 — — — — — — — — — 
  ܂𓍼 ⁝  [قناة السورس](t.me/Vc33h) 🔺.
]]
                    send(msg.chat_id_, msg.id_, help_text or Text)
...
܂𓍼 ⁝ وضع كليشه المطور 
܂𓍼 ⁝ حذف كليشه المطور 
܂𓍼 ⁝ تفعيل البوت الخدمي 
܂𓍼 ⁝ تعطيل البوت الخدمي
܂𓍼 ⁝ تفعيل ملف + اسم الملف
܂𓍼 ⁝ تعطيل ملف + اسم الملف
܂𓍼 ⁝  تعين عدد الاعضاء + العدد
 — — — — — — — — — 
܂𓍼 ⁝ غادر 
܂𓍼 ⁝ اذاعه 
܂𓍼 ⁝ رفع منشئ 
